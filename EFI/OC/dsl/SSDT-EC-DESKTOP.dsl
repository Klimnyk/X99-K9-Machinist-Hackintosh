 ...
 *
 * Disassembly of iASLUL2N7N.aml, Sun Sep 21 12:45:38 2025
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000190F (6415)
 *     Revision         0x02
 *     Checksum         0x7F
 *     OEM ID           "DRTNIA"
 *     OEM Table ID     "SsdtEC"
...
DefinitionBlock ("", "SSDT", 2, "DRTNIA", "SsdtEC", 0x00001000)
{
    ...
    External (_SB_.PCI0.SBRG.EC._STA, MethodObj)
    External (_SB_.PCI0.SBRG.EC0._STA, MethodObj)
    External (_SB_.PCI0.SBRG.H_EC._STA, MethodObj)
    External (_SB_.PCI0.SBRG.ECDV._STA, MethodObj)
    External (_SB_.PCI0.SBRG.PGEC._STA, MethodObj)
    External (_SB_.PCI0.LPCB.EC._STA, MethodObj)
    External (_SB_.PCI0.LPCB.EC0._STA, MethodObj)
    External (_SB_.PCI0.LPCB.EC__._STA, MethodObj)
    External (_SB_.PCI0.LPCB.ECDV._STA, MethodObj)
    External (_SB_.PCI0.LPCB.H_EC._STA, MethodObj)
    External (_SB_.PCI0.LPCB.PGEC._STA, MethodObj)
    External (_SB_.PCI0.LPC_.EC._STA, MethodObj)
    External (_SB_.PCI0.LPC_.EC0._STA, MethodObj)
    External (_SB_.PCI0.LPC_.H_EC._STA, MethodObj)
    External (_SB_.PCI0.LPC_.ECDV._STA, MethodObj)
    External (_SB_.PCI0.LPC_.PGEC._STA, MethodObj)
    External (_SB_.PCI0.PX40.EC._STA, MethodObj)
    External (_SB_.PCI0.PX40.EC0._STA, MethodObj)
    External (_SB_.PCI0.PX40.H_EC._STA, MethodObj)
    External (_SB_.PCI0.PX40.ECDV._STA, MethodObj)
    External (_SB_.PCI0.PX40.PGEC._STA, MethodObj)
    External (_SB_.PCI0.LPC0.EC._STA, MethodObj)
    External (_SB_.PCI0.LPC0.EC0._STA, MethodObj)
    External (_SB_.PCI0.LPC0.H_EC._STA, MethodObj)
    External (_SB_.PCI0.LPC0.ECDV._STA, MethodObj)
    External (_SB_.PCI0.LPC0.PGEC._STA, MethodObj)
    External (_SB_.PC00.LPC0.EC._STA, MethodObj)
    External (_SB_.PC00.LPC0.EC0._STA, MethodObj)
    External (_SB_.PC00.LPC0.H_EC._STA, MethodObj)
    External (_SB_.PC00.LPC0.ECDV._STA, MethodObj)
    External (_SB_.PC00.LPC0.PGEC._STA, MethodObj)
